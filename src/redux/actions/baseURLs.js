const baseURL = {
  // reservations: 'http://192.168.30.102:9003/reservations',
  // reservations: 'http://localhost:4000/login',
  // menus: 'http://192.168.30.102:9002/menuplan',
  // menus: 'http://localhost:4000/meals',
  // dishes: 'http://192.168.30.102:9001/dishes',
  // auth: 'http://192.168.30.102:9000/public/login',
